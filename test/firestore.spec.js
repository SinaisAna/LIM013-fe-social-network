...
import { createUserDB, getUserInformation, readUserDB, addLike, } from '../src/lib/firebase/firestore';
...
describe('readUserDB', () => {
  ...
  it('You should be able to authenticate the email to enter the page at login', () => {
  ...
  describe('addLike', () => {
    ...
    it('Debería poder dar like con mi usuario logueado', (done) => {
      return addLike('9URN4KSD9kw9HKNlo47B', 'pE6kjzWNn2ULhM3NWsljAP7BV662')
        .then((data) => {
